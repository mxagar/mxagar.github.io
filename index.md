...
<style>
    ...
    #front-image {
        ...
        max-width: 200px;
        display: block;
        margin: 0 auto 30px; /* Center the image and add margin below */
    }

    /* Styles for larger screens */
    @media (min-width: 480px) { /*768px 600px*/
        #front-image {
            float: left;
            margin-right: 30px;
            margin-bottom: 30px;
...
<img id="front-image" src="/assets/mikel_sagardia_big_lowres.jpg" alt="Mikel Sagardia" style="border: 10px solid white; box-shadow: 5px 5px 15px rgba(0, 0, 0, 0.3); transform: rotate(-3deg);" />
...
<h2 style="margin-top: 20px;">More about me</h2>
<!--## More about me -->
